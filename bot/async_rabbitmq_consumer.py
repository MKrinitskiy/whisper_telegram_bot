...
class RabbitMQConsumer(object):
    ...
    def __init__(self,
        ...
        self.arriving_messages_queue = arriving_messages_queue
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        try:
            with self.threading_lock:
                self.arriving_messages_queue.put(body, block=True)
        except Full as e:
            self.logger.error('Error while putting message in queue: %s', e)
...
class ReconnectingRabbitMQConsumer(object):
    def __init__(self, arriving_messages_queue, threading_lock, logger=None):
